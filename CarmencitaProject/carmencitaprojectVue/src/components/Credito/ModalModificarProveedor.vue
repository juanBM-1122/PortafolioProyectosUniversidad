            ...
            <div class="modal-container">
                ...
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <div class="col-span-1 mt-4">
                            ...
                            <input @input="formatear_nit(proveedor.nit_pr)" v-model="proveedor.nit_pr" type="text" id="nit"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                placeholder="NIT">
                        </div>
                        <div class="col-span-1 mt-4 w-[50%] ml-4">
                            ...
                            <input @input="formatear_nrc(proveedor.nrc_pr)" v-model="proveedor.nrc_pr" type="text" id="nrc"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                placeholder="NRC">
                        </div>
                    </div>
                ...
                <div>
                    <div class="text-center">
                        <button @click="modificar_proveedor()"
                            class="bg-indigo-500 text-white text-sm font-bold py-2 px-4 rounded-md hover:bg-indigo-600 transition duration-300">Guardar
                            Cambios</button>
...
export default {
    ...
    methods: {
        modificar_proveedor() {
            ...
            axios.put(api_url + "/proveedor/" + this.proveedor.id, this.proveedor)
                .then((res) => {
